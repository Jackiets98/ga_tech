...
<head>
    ...
    <link rel="icon" href="{{ asset('images/lca-logo.png') }}" type="image/png">
    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>
<body class="font-sans antialiased text-lca-gray-900 bg-white">
    {{-- Top bar --}}
    <div class="top-bar hidden md:block text-sm">
        <div class="container mx-auto px-4 py-2 flex items-center justify-between">
            <div class="flex items-center gap-6">
                <a href="mailto:info@lcaexpress.com" class="transition-colors flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                    info@lcaexpress.com
                </a>
                <a href="tel:+60198933455" class="transition-colors flex items-center gap-2">
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="#" aria-label="Facebook" class="transition-colors">
    ...
    {{-- Header --}}
    <header id="site-header" class="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-lca-gray-200 transition-shadow duration-300">
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between h-16 md:h-20">
                <a href="{{ url('/') }}#home" class="flex items-center group">
                    <img src="{{ asset('images/lca-logo.png') }}" alt="LCA Express — Sabah Logistics 物流公司" class="site-logo">
                </a>
                ...
                <button id="mobile-menu-btn" class="lg:hidden p-2 rounded-lg hover:bg-lca-yellow-soft transition-colors" aria-label="Toggle menu" aria-expanded="false">
        ...
        {{-- Mobile menu --}}
        <div id="mobile-menu" class="lg:hidden hidden border-t border-lca-gray-200 bg-white">
            <nav class="container mx-auto px-4 py-4 flex flex-col gap-1" aria-label="Mobile navigation">
                ...
                <div class="pt-4 mt-2 border-t border-lca-gray-200 flex flex-col gap-2">
    ...
    <footer class="site-footer">
        <div class="container mx-auto px-4 py-12 md:py-16">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
                <div>
                    <a href="{{ url('/') }}#home" class="inline-block mb-4">
                        <img src="{{ asset('images/lca-logo.png') }}" alt="LCA Express" class="h-14 w-auto object-contain">
                    </a>
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm">
                        <li class="flex gap-3">
                            <svg class="w-5 h-5 text-lca-yellow shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                        ...
                        <li class="flex gap-3">
                            <svg class="w-5 h-5 text-lca-yellow shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                            <span>Monday – Saturday<br>8:00 a.m. – 5:00 p.m.</span>
                        </li>
                        <li class="flex gap-3">
                            <svg class="w-5 h-5 text-lca-yellow shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
            ...
            <div class="border-t border-lca-gray-800 mt-10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm">
                <p>© LCA Express Sdn.Bhd. 2023–2025. All Rights Reserved. Co. No: 202301037402.</p>
                <p class="text-lca-gray-500">Proudly powered By CHAN</p>
            </div>
        </div>
    </footer>
